...
class PowerAuthTokenStore {
  ...
  Future<PowerAuthToken> requestAccessToken(
    String tokenName,
    PowerAuthAuthentication authentication,
  ) async {
    final result = await _platform.requestAccessToken(
      _instanceId,
      tokenName,
      authentication,
    );
  ...
  Future<PowerAuthAuthorizationHttpHeader> generateHeaderForToken(
    String tokenName,
  ) async {
    final result = await _platform.generateHeaderForToken(
      _instanceId,
      tokenName,
    );
