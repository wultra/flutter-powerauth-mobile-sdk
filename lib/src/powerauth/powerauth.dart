...
class PowerAuth {
  ...
  /// Returns the effective sharing configuration used for this instance on
  /// iOS, or `null` if activation sharing is not configured.
  ///
  /// If the input configuration omitted
  /// [PowerAuthSharingConfiguration.sharedMemoryIdentifier], the returned
  /// configuration contains the identifier generated by the native SDK.
  ///
  ...
  ///
  /// Use the same [instanceId], [configuration], [keychainConfiguration], and
  /// [sharingConfiguration] that were used to configure the instance.
